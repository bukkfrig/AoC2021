        ...
        first :: rest ->
            let
                ...
                boards =
                    parseBoards rest []
            in
            playUntilLast calledNumbers boards
...
playUntilLast : List Int -> List Board -> Int
playUntilLast nums state =
    case nums of
        x :: xs ->
            let
                newstate : List Board
            ...
            in
            case List.partition isWinner newstate of
                ( [ winner ], [] ) ->
                    score x winner

                ( _, losers ) ->
                    playUntilLast xs losers
